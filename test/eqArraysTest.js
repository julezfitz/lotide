...
describe("#eqArrays", () => {
  ...
  it("returns false for ['1', '2', '3'] is equal to ['1', '2', 3]", () => {
  ...
  it("returns true for [[2, 3], [4]] is equal to [[2, 3], [4]]", () => {
    assert.strictEqual(eqArrays([[2, 3], [4]], [[2, 3], [4]]), true);
  });
  it("returns false for [[2, 3], [4]] is equal to [[2, 3], [4, 5]]", () => {
    assert.strictEqual(eqArrays([[2, 3], [4]], [[2, 3], [4, 5]]), false);
  });
  it("returns false for [[2, 3], [4]] is equal to [[2, 3], 4]", () => {
